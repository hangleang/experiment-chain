...
pub use frame_support::{
	...
	traits::{
		ConstU128, ConstU32, ConstU64, ConstU8, FindAuthor, KeyOwnerProofSystem, 
		Randomness, StorageInfo, EqualPrivilegeOnly,
	},
	weights::{
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("node-frontier"),
	impl_name: create_runtime_str!("node-frontier"),
	authoring_version: 1,
...
impl pallet_dynamic_fee::Config for Runtime {
	type MinGasPriceBoundDivisor = U256::from(1024);
}
...
impl pallet_base_fee::Config for Runtime {
	...
	type IsActive = true;
	type DefaultBaseFeePerGas = U256::from(1_000_000_000);
}
